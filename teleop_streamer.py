...
class TeleopStreamer:
    def __init__(
        ...
        if self.enable_real_device:
            ...
            elif body_control_device == "quest3":
                from gr00t_wbc.control.teleop.streamers.quest3_streamer import Quest3Streamer

                self.body_streamer = Quest3Streamer()
                self.body_streamer.start_streaming()
            ...
            if hand_control_device and hand_control_device != body_control_device:
                if hand_control_device == "manus":
                    ...
                    self.hand_streamer.start_streaming()
                elif hand_control_device == "quest3":
                    from gr00t_wbc.control.teleop.streamers.quest3_streamer import Quest3Streamer

                    self.hand_streamer = Quest3Streamer()
                    self.hand_streamer.start_streaming()
                else:
