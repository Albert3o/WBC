...
kTopicLowCommand_ArmsMixer = "rt/lowcmd_arms"
...
class G1_29_ArmController:
    def __init__(self, motion_mode = False, simulation_mode = False, lowcmd_topic: Optional[str] = None):
        ...
        if lowcmd_topic is not None:
            selected_lowcmd_topic = lowcmd_topic
        elif self.motion_mode:
            selected_lowcmd_topic = kTopicLowCommand_Motion
        else:
            selected_lowcmd_topic = kTopicLowCommand_Debug

        self.lowcmd_publisher = ChannelPublisher(selected_lowcmd_topic, hg_LowCmd)
