    ...
    class __Reader:
        ...
        def Read(self, timeout: float = None):
            ...
            try:
                ...
                # Timed wait with no sample (normal for polling).
                pass
            except StopIteration:
                # take_one(timeout=...) may exhaust take_iter without TimeoutError on some cyclonedds-python builds.
                if timeout is None:
                    raise
                pass
                ...
                print(f"[Reader] take sample error: {type(e).__name__}: {e!r}")
